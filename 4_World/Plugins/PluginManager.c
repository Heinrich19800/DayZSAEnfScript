...
{	
	...
	{	
		...
		RegisterPlugin( "PluginKeyBinding",					true, 	false, 	false );
		RegisterPlugin( "PluginDeveloper",					true, 	true, 	false );
		RegisterPlugin( "PluginDeveloperSync",				true, 	true, 	false );
		RegisterPlugin( "PluginRecipesManager",				true, 	true, 	false );
		RegisterPlugin( "PluginSceneManager",				true, 	true, 	false );
		RegisterPlugin( "PluginConfigScene",				true, 	true, 	false );
		RegisterPlugin( "PluginConfigDebugProfile",			true, 	true, 	false );
		RegisterPlugin( "PluginConfigDebugProfileFixed",	true, 	true, 	false );
