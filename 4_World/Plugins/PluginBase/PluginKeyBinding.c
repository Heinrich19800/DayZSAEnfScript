...
class PluginKeyBinding extends PluginBase
{
	...
	void OnInit()
	{
		...
		//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		RegisterKeyBind(	 MENU_ANY						,KeyCode.KC_F1			,-1					,"PluginDeveloper"		,"ToggleHelpScreen" 			,"[F1]"							,"Show/Hide help screen");
		...
		RegisterKeyBind(	 MENU_NONE						,KeyCode.KC_HOME		,-1					,"PluginDeveloper"		,"ToggleFreeCamera"				,"[Home]"						,"Ingame => Toggle free camera, back on position");
		RegisterKeyBind(	 MENU_NONE						,KeyCode.KC_DIVIDE		,-1					,"PluginDeveloper"		,"ToggleFreeCameraBackPos"		,"[Divide numeric]"				,"Ingame => Toggle free camera, teleport player on free camera position");
		...
		RegisterKeyBind(	 MENU_ANY						,KeyCode.KC_LCONTROL	,KeyCode.KC_BACK	,"PluginRecipesManager"	,"CallbackGenerateCache"		,"[LCtrl]+[BACKSPACE]"			,"PluginRecipesManager => Generate recipe cache and save it to file");
		RegisterKeyBind(	 MENU_ANY						,KeyCode.KC_LCONTROL	,KeyCode.KC_DECIMAL	,"PluginItemDiagnostic"	,"ToggleDebugWindowEvent"		,"[LCtrl]+[KeyCode.KC_DECIMAL]"	,"Close the Item Debug window");
		RegisterKeyBind(	 MENU_ANY						,KeyCode.KC_LWIN		,KeyCode.KC_NUMPAD0	,"PluginDayzPlayerDebug","ToggleDebugWindowEvent"		,"[LWin]+[KeyCode.KC_NUMPAD0]"	,"Open/Close Player debug window");
		RegisterKeyBind(	 MENU_ANY						,KeyCode.KC_LWIN		,KeyCode.KC_DECIMAL	,"PluginDayzPlayerDebug","ToggleDebugWindowEventP"		,"[LWin]+[KeyCode.KC_NUMPAD0]"	,"Open/Close Player debug window");
		RegisterKeyBind(	 MENU_NONE						,KeyCode.KC_LCONTROL	,KeyCode.KC_P		,"PluginHologramDebug"	,"TogglePlacingDebug"			,"[LCtrl]+[P]"					,"Start/finish precise object placemet using key press");
		RegisterKeyBind(	 MENU_NONE						,-1						,KeyCode.KC_P		,"PluginHologramDebug"	,"PlaceHologramDebug"			,"[P]"							,"Stop precise object placemet using key press");
		//--------------------------------------------------------------------------------------------------------------------------------------------------------------
		
