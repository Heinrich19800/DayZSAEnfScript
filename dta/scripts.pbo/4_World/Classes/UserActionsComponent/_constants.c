...
const int AT_MINE_TREE_FENCE = 110;
const int AT_MINE_TREE_WATCHTOWER = 111;
...
//const int AT_IGNITE_FIREPLACE_BY_HANDDRILL = 174; <-- free to use (removed)
//const int AT_IGNITE_FIREPLACE_BY_ROADFLARE = 175; <-- free to use (removed)
...
const int AT_MINE_TREE_ACTION_SWITCH = 575;
