...
// >> Public Scope
	...
	Widget Init()
	{
		...
		m_Popups.Insert(POPUP_ID_SQF_WATCHERS,		new UIPopupScriptSQFWatchers(wgt.FindAnyWidget("pnl_popup_sqf_watchers")));
		m_Popups.Insert(POPUP_ID_CONFIGS,		new UIPopupScriptConfigs(wgt.FindAnyWidget("pnl_popup_configs")));
		
		m_PresetsTextListbox = wgt.FindAnyWidget("pnl_presets");
		m_PresetItemsTextListbox = wgt.FindAnyWidget("pnl_preset_items");
		...
		m_PresetAddItemtButton = wgt.FindAnyWidget("btn_add_to_preset");
		m_PresetRemoveItemButton = wgt.FindAnyWidget("btn_remove_from_preset");
		m_SpawnOnGroundButton = wgt.FindAnyWidget("btn_spawn_on_ground");
		m_SpawnInInventoryButton = wgt.FindAnyWidget("btn_spawn_in_inventory");
		m_SpawnAsAttachmentButton = wgt.FindAnyWidget("btn_spawn_as_attachment");
		m_UpButton = wgt.FindAnyWidget("btn_up");
		m_DownButton = wgt.FindAnyWidget("btn_down");
		m_Developer					= (PluginDeveloper)GetPlugin(PluginDeveloper);
		m_QuantityEditBox = wgt.FindAnyWidget("txt_quantity_value");
		m_DamageEditBox = wgt.FindAnyWidget("txt_damage_value");
		m_SpawnDistanceEditBox = wgt.FindAnyWidget("txt_distance_value");
		m_PresetNewButton = wgt.FindAnyWidget("btn_new");
		m_PresetDeleteButton = wgt.FindAnyWidget("btn_delete");
		m_PresetRenameButton = wgt.FindAnyWidget("btn_rename");
		m_PresetSetDefaultButton = wgt.FindAnyWidget("btn_default");
		m_CopyToClipboardButton = wgt.FindAnyWidget("btn_copy_to_clipboard");
		m_SQFButton = wgt.FindAnyWidget("btn_sqf");
		m_ConfigsButton = wgt.FindAnyWidget("btn_top_configs");
	...
	void SceneEditorCommand( Param params )
	{
		...
		switch ( cmd_id )
		{
			...
			case PluginSceneManager.SCENE_EDITOR_CMD_POPUP:
				...
				if( m_PopupWatchers != m_Popups.Get(popup_curr_id) )
				{
...
// >> protected Scope	
	...
	{	
		array<SceneObject> scene_objects =  m_ModuleSceneManager.GetSceneObjectsAll();
